...
abstract class Letter() {
    ...
    data class Default(override val type: LetterType, override val char: Char) : Letter() {
    ...
    data class UserClicked(override val type: LetterType, override val char: Char) : Letter() {
        override val borderColor: Color = if (type is LetterType.Card) yellow else gray
        override val cardColor: Color = black
        override val charColor: Color = white
        override val angle: Float = 0f
    ...
    data class Wrong(override val type: LetterType, override val char: Char) : Letter() {
    ...
    data class Right(override val type: LetterType, override val char: Char) : Letter() {
    ...
    data class Exact(override val type: LetterType, override val char: Char) : Letter() {
